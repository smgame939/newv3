...
<head>
    ...
    <title>SMGame Newtemplate V3 :: Live Sports</title>
    <base href=".">
    ...
    <link rel="stylesheet" href="css/live_sports.css?v=<?php echo $ver; ?>">

    <?php if ($mdetect->isMobile()) { ?>
    <link rel="stylesheet" href="mobilecss/main.css?v=<?php echo $ver; ?>">
    <link rel="stylesheet" href="mobilecss/live_sports_m.css?v=<?php echo $ver; ?>">
...
<body>
  ...
  <?php
  if ($mdetect->isMobile()) {
    include('pages/live_sports_m.php');
  } else {
  ?>
    <!-- END MOBILE -->
    <!-- DESKTOP -->
  <?php
    include('pages/live_sports_pc.php');
  }
  ?>
  <!-- END DESKTOP -->
