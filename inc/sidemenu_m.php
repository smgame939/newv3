<nav data-v-c6087bcb="" class="slide-content-left"><!----><!---->
    ...
    <ul class="main-other-menu">
        ...
        <li style="display: none;">
            <a href="javascript: void(0)" aria-label="럭키 휠"><!----><span class="icon-roulette"></span>
                <div>럭키 휠</div>
            </a>
        </li>
        <li>
        ...
        <li style="display: none;">
            <a href="javascript: void(0)" aria-label="마켓"><!----><span class="icon-mall"></span>
                <div>마켓</div>
            </a>
        </li>
        <li>
