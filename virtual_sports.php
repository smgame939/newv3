...
<head>
    ...
    <link rel="stylesheet" href="css/virtualsports.css?v=<?php echo $ver; ?>">
    ...
    <?php if ($mdetect->isMobile()) { ?>
        ...
        <link rel="stylesheet" href="mobilecss/virtual_sports_m.css?v=<?php echo $ver; ?>">
...
<body>
    ...
    <?php
    if ($mdetect->isMobile()) {
        include('pages/virtual_sports_m.php');
    } else {
    ?>
        <!-- END MOBILE -->
        <!-- DESKTOP -->
    <?php
        include('pages/virtual_sports_pc.php');
    }
    ?>
    <!-- END DESKTOP -->
